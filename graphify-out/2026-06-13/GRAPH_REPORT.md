...
Cohesion: 0.09
Nodes (15): appleLoginModel, googleLoginModel, confirmResetPasswordModal, forgotPasswordEmailModal, loginModel, CreatePromoCodeDto, UpdatePromoCodeDto, ValidatePromoDto (+7 more)

### Community 15 - "Bootstrap Eventpubsubbootstrap"
Cohesion: 0.08
Nodes (40): bootstrapEventPubSubBridge(), logger, BOOKING_EVENTS, extractParticipantIds(), handleBookingEvent(), handleSessionListInvalidation(), logger, registerDomainEventHandlers() (+32 more)
...
Cohesion: 0.16
Nodes (14): adminAddAccountDeletionNote(), adminDenied(), adminListAccountDeletions(), adminRestoreAccountDeletion(), serialize(), AdminController, adminController, authorizeMiddleware (+6 more)
...
Cohesion: 0.27
Nodes (15): adminCreateBanner(), adminDeleteBanner(), adminDenied(), adminListBanners(), adminToggleBanner(), adminUpdateBanner(), AUDIENCE_VALUES, PLACEMENTS (+7 more)
...
### Community 133 - "Common Commonroutes Commonroute"
Cohesion: 0.07
Nodes (11): ACTIVE_CLIP, loadCategoryMaps(), nestClipsByTaxonomy(), NestedCategoryGroup, commonService, clip_library_submission, clipLibrarySubmissionSchema, LIBRARY_SUBMISSION_STATUSES (+3 more)
